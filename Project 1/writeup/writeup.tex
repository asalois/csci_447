...
of our models built using 5 different datasets acquired from the UCI Machine Learning Repository
...
Naïve Bayes is simple classification algorithm using 
...
The implementation of the ten-fold cross-validation was intended to be straightforward. Due to the nature of this function,
it was decided that
